...
func (in *ConnectorSpec) DeepCopyInto(out *ConnectorSpec) {
	*out = *in
	...
	if in.ExportOffsets != nil {
		in, out := &in.ExportOffsets, &out.ExportOffsets
		*out = new(OffsetsSpec)
		**out = **in
	}
	if in.ImportOffsets != nil {
		in, out := &in.ImportOffsets, &out.ImportOffsets
		*out = new(OffsetsSpec)
		**out = **in
	}
}
...
func (in *ConnectorStatus) DeepCopyInto(out *ConnectorStatus) {
	*out = *in
	...
	if in.LastImportedOffsetsAt != nil {
		in, out := &in.LastImportedOffsetsAt, &out.LastImportedOffsetsAt
		*out = (*in).DeepCopy()
	}
	if in.LastResetOffsetsAt != nil {
		in, out := &in.LastResetOffsetsAt, &out.LastResetOffsetsAt
		*out = (*in).DeepCopy()
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Log4jJsonLayoutConfig) DeepCopyInto(out *Log4jJsonLayoutConfig) {
	*out = *in
	if in.Image != nil {
		in, out := &in.Image, &out.Image
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Log4jJsonLayoutConfig.
func (in *Log4jJsonLayoutConfig) DeepCopy() *Log4jJsonLayoutConfig {
	if in == nil {
		return nil
	}
	out := new(Log4jJsonLayoutConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LoggingConfig) DeepCopyInto(out *LoggingConfig) {
	*out = *in
	...
	if in.Log4jJsonLayout != nil {
		in, out := &in.Log4jJsonLayout, &out.Log4jJsonLayout
		*out = new(Log4jJsonLayoutConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OffsetsSpec) DeepCopyInto(out *OffsetsSpec) {
	*out = *in
	out.ConfigMapRef = in.ConfigMapRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OffsetsSpec.
func (in *OffsetsSpec) DeepCopy() *OffsetsSpec {
	if in == nil {
		return nil
	}
	out := new(OffsetsSpec)
