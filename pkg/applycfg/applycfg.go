...
// EnvVar converts a corev1.EnvVar to its apply configuration.
func EnvVar(e corev1.EnvVar) *corev1ac.EnvVarApplyConfiguration {
	return &corev1ac.EnvVarApplyConfiguration{
		Name:      &e.Name,
		Value:     &e.Value,
		ValueFrom: envVarSource(e.ValueFrom),
	}
}

func envVarSource(s *corev1.EnvVarSource) *corev1ac.EnvVarSourceApplyConfiguration {
	if s == nil {
		return nil
	}
	return &corev1ac.EnvVarSourceApplyConfiguration{
		FieldRef:         objectFieldSelector(s.FieldRef),
		ResourceFieldRef: resourceFieldSelector(s.ResourceFieldRef),
		ConfigMapKeyRef:  configMapKeySelector(s.ConfigMapKeyRef),
		SecretKeyRef:     secretKeySelector(s.SecretKeyRef),
	}
}

func objectFieldSelector(s *corev1.ObjectFieldSelector) *corev1ac.ObjectFieldSelectorApplyConfiguration {
	if s == nil {
		return nil
	}
	return &corev1ac.ObjectFieldSelectorApplyConfiguration{
		APIVersion: &s.APIVersion,
		FieldPath:  &s.FieldPath,
	}
}

func resourceFieldSelector(s *corev1.ResourceFieldSelector) *corev1ac.ResourceFieldSelectorApplyConfiguration {
	if s == nil {
		return nil
	}
	return &corev1ac.ResourceFieldSelectorApplyConfiguration{
...
func configMapKeySelector(s *corev1.ConfigMapKeySelector) *corev1ac.ConfigMapKeySelectorApplyConfiguration {
	if s == nil {
		return nil
	}
	return &corev1ac.ConfigMapKeySelectorApplyConfiguration{
...
func secretKeySelector(s *corev1.SecretKeySelector) *corev1ac.SecretKeySelectorApplyConfiguration {
	if s == nil {
		return nil
	}
	return &corev1ac.SecretKeySelectorApplyConfiguration{
		LocalObjectReferenceApplyConfiguration: corev1ac.LocalObjectReferenceApplyConfiguration{
			Name: &s.Name,
		},
		Key:      &s.Key,
